...
const users = [
    ...
    { username: "mariaclara", password: "mariaclara" },
...
if (window.location.pathname.includes("app.html")) {
    ...
    if (username) {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Inicializar o mapa
            const map = L.map('map').setView([-24.7144, -53.7417], 13);
            ...
            const drawControl = new L.Control.Draw({
                draw: {
                    ...
                    polyline: false, // Desabilitar polilinhas
                    polygon: false, // Desabilitar polígonos
                    circle: false, // Desabilitar círculos
                    circlemarker: false, // Desabilitar marcadores de círculo
            ...
            map.on('draw:created', function (e) {
                ...
                Swal.fire({
                    ...
                    html:
                        '<input id="swal-input1" class="swal2-input" placeholder="Nome do bar">' +
